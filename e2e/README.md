# `e2e/` — the twenty-five specs: BUILD M8's seventeen and `18`–`25`
...
e2e/
  ...
  cypress/e2e/*.cy.ts      the twenty-five specs (`99-online-smoke` is skipped unless enabled)
