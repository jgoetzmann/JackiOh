...
// with fixture accounts). Fourteen specs, every one seeded, no fixed waits.
...
export default defineConfig({
  ...
  // suite stays at fourteen files and `cypress run` (no flag) still runs exactly those fourteen.
  component: {
    devServer: {
      framework: "react",
      bundler: "vite",
