...
| 96 | My Pawn | 3 | Lethal detection accounts for armor and the cap (R44); attack cancelled; AI finishes the turn deterministically from the seed; opponent's actions rejected until end of turn; radiant destroys the attacker first, an Indestructible one knocked down (R283) |
