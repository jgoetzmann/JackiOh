...
E2E=1 pnpm --dir apps/server dev    # :8787 + /ws/match; needed for networked specs 05, 06, 07, 09, 10, 18, 19, 20, 27
...
- `sql`: `test:sql`.
- `db`: `test:db`.
- `e2e`: the twenty-five specs (`01`–`24` and `27`) on Chrome and on Electron, plus the component specs on Chrome.
